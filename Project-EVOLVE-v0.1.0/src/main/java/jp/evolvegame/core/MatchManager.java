...
public final class MatchManager {
    ...
    public void updateSidebar(Player player) {
        ...
        obj.getScore(ChatColor.WHITE + "State: " + ChatColor.YELLOW + state.name()).setScore(6);
        obj.getScore(ChatColor.WHITE + "Role: " + ChatColor.AQUA + getRole(player.getUniqueId()).name()).setScore(5);
        obj.getScore(ChatColor.WHITE + "Stage: " + ChatColor.RED + monsterStage).setScore(4);
        obj.getScore(ChatColor.WHITE + "Evolution: " + ChatColor.LIGHT_PURPLE + evolution).setScore(3);
        obj.getScore(ChatColor.WHITE + "Players: " + ChatColor.GREEN + joined.size()).setScore(2);
        obj.getScore(ChatColor.DARK_GRAY + "v0.1.0").setScore(1);
